...
export const MOCK_COURSES: Course[] = [
  {
    ...
    lmsCourseId: 'gc-eng-101-p2',
  },
  {
    id: 'course-2',
    code: 'HIST-204',
    title: 'US History Honors: Industrial Era to Modern',
    section: 'Period 4',
    studentCount: 31,
    term: 'Fall 2026',
    lmsPlatform: 'google_classroom',
    lmsCourseId: 'gc-hist-204-p4',
  },
  {
    id: 'course-3',
    code: 'BIO-302',
    title: 'Biology Honors & Lab Science',
    section: 'Period 1',
    studentCount: 24,
    term: 'Fall 2026',
    lmsPlatform: 'canvas',
    lmsCourseId: 'canvas-bio-302-p1',
  },
];
...
export const MOCK_SUBMISSIONS: Submission[] = [
  {
    ...
    assignmentTitle: 'Rhetorical Essay: To Kill a Mockingbird',
    courseId: 'course-1',
    submissionType: 'handwritten',
    fileType: 'image',
    documentImageUrls: [
      createHandwrittenNotebookSvg(MOCK_ESSAY_TEXT_1, "Rhetorical Power in Atticus Finch's Speech", "Sept 18, 2026")
    ],
    ocrText: MOCK_ESSAY_TEXT_1,
    ocrConfidence: 98.8,
    ocrProcessingTimeMs: 280,
    annotations: [
      {
        id: 'ann-1',
        type: 'circle',
        points: [{ x: 130, y: 120 }, { x: 420, y: 120 }, { x: 420, y: 135 }, { x: 130, y: 135 }],
        color: '#dc2626',
        strokeWidth: 3,
        page: 0,
      ...
      },
      {
        id: 'ann-2',
        type: 'underline',
        points: [{ x: 130, y: 220 }, { x: 680, y: 220 }],
        color: '#2563eb',
        strokeWidth: 2,
        page: 0,
        timestamp: '2026-09-18T10:16:20Z',
      },
    ],
    scores: [
      { criterionId: 'crit-1', score: 1, comment: 'Clear, defensible thesis linking ethos, pathos, and logos to Maycomb’s racial prejudice.', aiSuggestedScore: 1 },
      { criterionId: 'crit-2', score: 4, comment: 'Outstanding textual commentary! Beautifully highlights the physical evidence of Tom’s left arm.', aiSuggestedScore: 4 },
      { criterionId: 'crit-3', score: 1, comment: 'Sophisticated prose with strong rhetorical vocabulary (ethos, pathos, logos, constitutional responsibility).', aiSuggestedScore: 1 },
    ],
    rubricId: 'rubric-1',
    totalScore: 6,
    maxScore: 6,
    feedbackSummary: 'Exceptional work, Maya! Your analysis of Atticus Finch’s closing argument is insightful and well-structured. You effectively integrated textual evidence regarding Tom’s left arm and linked it to the broader themes of justice.',
    strengths: ['Specific textual evidence', 'Nuanced understanding of rhetorical appeals', 'Seamless paragraph transitions'],
    areasForImprovement: ['Elaborate slightly more on Bob Ewell’s background context in paragraph 4'],
    voiceNotes: [
      {
        id: 'vn-1',
        timestamp: '2026-09-18T10:18:00Z',
        durationSeconds: 18,
        transcript: 'Maya, wonderful essay! I loved how you cited the specific detail about Tom Robinson’s arm to prove the logos claim. Keep up this brilliant work!',
      },
    ],
    lmsStatus: 'synced_to_lms',
    lmsSyncedAt: '2026-09-18T10:20:00Z',
    submissionDate: '2026-09-17T14:30:00Z',
    lmsAssignmentId: 'gc-assign-101',
  },
  {
    id: 'sub-2',
    studentId: 'stu-2',
    studentName: 'Liam Chen',
    assignmentTitle: 'DBQ: Industrial Era & Urban Working Class',
    courseId: 'course-2',
    submissionType: 'handwritten',
    fileType: 'image',
    documentImageUrls: [
      createHandwrittenNotebookSvg(MOCK_ESSAY_TEXT_2, "DBQ: Industrial Era Working Class", "Sept 17, 2026")
    ],
    ocrText: MOCK_ESSAY_TEXT_2,
    ocrConfidence: 97.4,
    ocrProcessingTimeMs: 310,
    annotations: [],
    scores: [
      { criterionId: 'crit-dbq-1', score: 1, comment: 'Good introduction setting up urbanization and economic shifts in the late 19th century.', aiSuggestedScore: 1 },
      { criterionId: 'crit-dbq-2', score: 2, comment: 'Accurately used Documents A & B. Add 2 more documents to reach the top level of 4 primary sources.', aiSuggestedScore: 2 },
    ],
    rubricId: 'rubric-2',
    totalScore: 3,
    maxScore: 4,
    feedbackSummary: 'Solid historical analysis, Liam! You incorporated Jacob Riis and factory conditions effectively. To score full points on DBQs, remember to weave in at least 4 primary documents.',
    strengths: ['Accurate primary source citation', 'Clear contextualization of Progressive Era reforms'],
    areasForImprovement: ['Incorporate at least 2 additional primary documents from the DBQ packet'],
    voiceNotes: [],
    lmsStatus: 'graded_draft',
    submissionDate: '2026-09-17T16:00:00Z',
    lmsAssignmentId: 'gc-assign-102',
  },
  {
    id: 'sub-3',
    studentId: 'stu-3',
    ...
    fileType: 'text',
    documentImageUrls: [],
    ocrText: `To Kill a Mockingbird Rhetorical Analysis
By Sophia Rodriguez

In the book To Kill a Mockingbird, Atticus Finch gives a speech to defend Tom Robinson. Atticus tries to convince the jury that Tom is innocent.

First, Atticus says that everybody is equal in the court. He talks about Jefferson and the constitution. This makes the jury feel like they have to do what is fair.

Second, Atticus talks about Mayella. She was lonely and sad. But she lied because she was scared of her father Bob Ewell.

Lastly, Tom Robinson could not hit Mayella because his hand was broken in a cotton gin. So it must have been Bob Ewell who hit her.

In conclusion, Atticus Finch made a good argument and the jury should have let Tom go free.`,
    ocrConfidence: 100.0,
    ocrProcessingTimeMs: 110,
    annotations: [],
    scores: [
      { criterionId: 'crit-1', score: 1, comment: 'Thesis is present but quite simple. Work on establishing a broader rhetorical line of reasoning.', aiSuggestedScore: 1 },
      { criterionId: 'crit-2', score: 2, comment: 'Refers to key facts but commentary is brief and lacks textual analysis depth.', aiSuggestedScore: 2 },
      { criterionId: 'crit-3', score: 0, comment: 'Sentences are repetitive. Focus on expanding vocabulary and rhetorical terms.', aiSuggestedScore: 0 },
    ],
    rubricId: 'rubric-1',
    totalScore: 3,
    maxScore: 6,
    feedbackSummary: 'Sophia, you identified the main arguments of Atticus’s speech correctly! For your next draft, let’s work on adding direct quotes from the text and explaining HOW Atticus uses persuasive techniques like ethos and pathos.',
    strengths: ['Correct identification of core facts', 'Clear paragraph breaks'],
    areasForImprovement: ['Include direct quotes from the book', 'Expand commentary explaining rhetorical strategies'],
    voiceNotes: [],
    lmsStatus: 'unassessed',
    submissionDate: '2026-09-18T09:15:00Z',
    lmsAssignmentId: 'gc-assign-101',
  },
];
...
export const GOOGLE_CLASSROOM_ASSIGNMENTS: ClassroomAssignment[] = [
  {
    id: 'gc-assign-1',
    courseId: 'course-1',
    courseTitle: 'AP English Literature & Composition',
    title: 'Rhetorical Essay: To Kill a Mockingbird',
    description: 'Analyze Atticus Finch’s closing courtroom defense with focus on ethos, pathos, logos, and constitutional equal justice claims.',
    dueDate: 'Sept 22, 2026',
    maxPoints: 6,
    submissionCount: 28,
    ungradedCount: 4,
    rubricTitle: 'AP Synthesis & Rhetorical Essay Rubric',
    rubricId: 'rubric-1',
    status: 'published',
  },
  {
    id: 'gc-assign-2',
    courseId: 'course-2',
    courseTitle: 'US History Honors: Industrial Era to Modern',
    title: 'DBQ: Industrial Era & Urban Working Class',
    description: 'Synthesize at least 4 primary documents evaluating the social, economic, and health impacts of 19th-century American industrialization.',
    dueDate: 'Sept 25, 2026',
    maxPoints: 10,
    submissionCount: 31,
    ungradedCount: 6,
    rubricTitle: 'Document-Based Question (DBQ) History Rubric',
    rubricId: 'rubric-2',
    status: 'published',
  },
  {
    ...
    courseId: 'course-1',
    courseTitle: 'AP English Literature & Composition',
    title: 'Hamlet: Soliloquy & Character Psychology Analysis',
    description: 'Examine Hamlet’s "To be or not to be" soliloquy in Act III Scene 1. Evaluate Shakespeare’s use of meter, syntax, and existential paradox.',
    dueDate: 'Oct 02, 2026',
    maxPoints: 6,
    submissionCount: 26,
    ungradedCount: 26,
  ...
  },
  {
    id: 'gc-assign-4',
    courseId: 'course-3',
    courseTitle: 'Biology Honors & Lab Science',
    title: 'Lab Report: Enzyme Catalysis & Reaction Rates',
    description: 'Submit formal scientific lab report including hypothesis, data tables, rate curves, and biological error analysis.',
    dueDate: 'Oct 05, 2026',
    maxPoints: 20,
    submissionCount: 24,
    ungradedCount: 12,
    rubricTitle: 'Scientific Inquiry & Lab Rubric',
    rubricId: 'rubric-1',
    status: 'published',
  },
];
